...
fn ploos<X: Clone, Y: Clone, T>(x: Vec<ArrayD<X>>, y: Vec<ArrayD<Y>>) -> Result<Vec<T>>
where
    X: Add<Y>,
    // TODO: this was generated by the compiler, there must be a way to write: T: (Add<X, Y>::Output)
    Vec<T>: FromIterator<<X as Add<Y>>::Output>,
{
